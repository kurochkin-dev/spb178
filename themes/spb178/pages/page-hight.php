...
<div class="hight-container">
	<div class="hight-container__outer container__outer">
		<div class="div_dop_button">
			<img id="button1" class="dop_button button-roof" src="<?php bloginfo('template_directory'); ?>/images/rem_krishi_dop4.jpg" alt="Ремонт крыши">
			<img id="button2" class="dop_button button-snow" src="<?php bloginfo('template_directory'); ?>/images/ochistka_ot_snega_dop4.jpg" alt="Очистка снега">
			<img id="button3" class="dop_button button-facade" src="<?php bloginfo('template_directory'); ?>/images/rem_fasad_dop4.jpg" alt="Ремонт фасадов">
		</div>
