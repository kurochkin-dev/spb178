		...
		<section id="header-sec-two">
			<header class="header__section-two">
				<div class="header__logo">
					<a href="/">
						<picture>
							<source srcset="<?php echo bloginfo('template_url'); ?>/img/logo.webp" type="image/webp">
							<img id="logo" src="<?php echo bloginfo('template_url'); ?>/img/logo.png"
								 alt="Логотип компании ООО СтройСнаб">
						</picture>
					</a>
				</div>
					...
					<nav>
						...
						<ul>
							...
							<li id="li1">
								...
								<img class="svg" src="<?php echo bloginfo('template_url'); ?>/img/icons/triangle.svg"
									 alt="Анимированный треугольник для выпадного меню">
								<ul id="sub-menu" aria-haspopup="true">
									...
									<li><a href="/service/vnutrennii_remontnie_raboti">Внутренние ремонтные работы</a>
									</li>
	...
	<div id="modalW" class="modalW">
		...
		<div class="forma">
			<div class="forma-group">
				...
				<input name="name" type="text" placeholder="Имя" class="forma-group-input" minlength="2" maxlength="30"
					   required>
			</div>
			<div class="forma-group">
			...
			<div class="forma-group">
				...
				<textarea id="message" name="message" rows="3" placeholder="Сообщение (не более 500 символов)"
	...
	<section id="about">
		<div class="about">
			...
			<div class="about__video">
				<video autoplay muted loop poster="<?php echo bloginfo('template_url'); ?>/img/video.jpg">
					<source src="<?php echo bloginfo('template_url'); ?>/img/video.webm" type="video/webm">
					<source src="<?php echo bloginfo('template_url'); ?>/img/video.mp4" type="video/mp4">
				</video>
				<div class="about__description">
					<p>Компания «СтройСнаб» работает с 2010 года, и, судя по <a href="/about/">отзывам</a> наших
						Заказчиков,
					...
					<p>Своими главными ценностями считаем качество выполненных работ и дружный коллектив. В штате
						компании
					...
					<p>Современные реалии диктуют новые правила игры, и либо организация будет развиваться, либо
						деградировать. ООО «СтройСнаб» выбрало первый путь, решив не просто сохранить то, что имеет, а
						выйти
					...
					<p>В связи с расширением, мы, коллектив «СтройСнаб», ищем новых сотрудников, которые станут нашими
						настоящими соратниками и боевыми товарищами. Если Вы готовы выполнять свои обязанности на
						совесть, а
						не «спустя рукава», Вы являетесь профессионалом в своей специальности и желаете, чтобы Ваши
						умения
						были оценены по достоинству, ищите не временную подработку, а работу и коллег не на один год –
						тогда
			...
			<div id="slider" class="vacancy-slider">
				<div class="vacancy-slide">
					<picture>
						...
						<source srcset="<?php echo bloginfo('template_url'); ?>/img/krovelshik.webp" type="image/webp"
								loading="lazy">
						<img src="<?php echo bloginfo('template_url'); ?>/img/krovelshik.jpg"
				...
				<div class="vacancy-slide">
					<picture>
						...
						<source srcset="<?php echo bloginfo('template_url'); ?>/img/malar.webp" type="image/webp"
								loading="lazy">
						<img src="<?php echo bloginfo('template_url'); ?>/img/malar.jpg"
							 alt="Вакансия штукатура-маляра компании ООО СтройСнаб" loading="lazy">
					</picture>
					<p>Штукатур-маляр</p>
				</div>
				<div class="vacancy-slide">
					<picture>
						...
						<source srcset="<?php echo bloginfo('template_url'); ?>/img/universal.webp" type="image/webp"
								loading="lazy">
						<img src="<?php echo bloginfo('template_url'); ?>/img/universal.jpg"
							 alt="Вакансия отделочника-универсала компании ООО СтройСнаб" loading="lazy">
					</picture>
				...
				<div class="vacancy-slide">
					<picture>
						...
						<source srcset="<?php echo bloginfo('template_url'); ?>/img/manager.webp" type="image/webp"
								loading="lazy">
						<img src="<?php echo bloginfo('template_url'); ?>/img/universal.jpg"
							 alt="Вакансия отделочника-универсала компании ООО СтройСнаб" loading="lazy">
					</picture>
		...
		<div class="choose">
			...
			<div class="choose-container">
				<div class="choose__card">
					<picture>
						<source srcset="<?php echo bloginfo('template_url'); ?>/img/icons/money.webp" type="image/webp"
								loading="lazy">
						<img src="<?php echo bloginfo('template_url'); ?>/img/icons/money.png"
				...
				<div class="choose__card">
					<picture>
						<source srcset="<?php echo bloginfo('template_url'); ?>/img/icons/ruki.webp" type="image/webp"
								loading="lazy">
						<img src="<?php echo bloginfo('template_url'); ?>/img/icons/ruki.png"
							 alt="Дружный коллектив - ООО СтройСнаб" loading="lazy">
					</picture>
					<p>Дружный<span>коллектив</span></p>
				</div>
				<div class="choose__card">
					<picture>
						<source srcset="<?php echo bloginfo('template_url'); ?>/img/icons/year.webp" type="image/webp"
								loading="lazy">
						<img src="<?php echo bloginfo('template_url'); ?>/img/icons/year.png"
							 alt="Больше 10 лет на рынке - ООО СтройСнаб" loading="lazy">
					</picture>
					<p>Больше 10 лет на<span>рынке</span></p>
				</div>
				<div class="choose__card">
					<picture>
						<source srcset="<?php echo bloginfo('template_url'); ?>/img/icons/time.webp" type="image/webp"
								loading="lazy">
						<img src="<?php echo bloginfo('template_url'); ?>/img/icons/time.png"
							 alt="Работа вне зависимости от сезона - ООО СтройСнаб" loading="lazy">
					</picture>
			...
			<div class="container">
				...
				<div id="contacts-right-column" class="contacts-right-column">
					<button id="vacancy-btn" aria-label="Закрыть окно вакансии">
						<img class="svg" src="<?php echo bloginfo('template_url'); ?>/img/icons/x-mark.svg"
					...
					<div class="forma" aria-label="Форма обратной связи присоединения к команде специалистов">
						...
						<button id="contacts-send" type="button" aria-haspopup="false"
								aria-label="Кнопка отправки запроса на присоединение к команде специалистов компании ООО СтройСнаб">
