...
<section class="container__policy">
	...
	<h1 class="policy__title"><strong>Политика в отношении обработки персональных данных</strong></h1>
	...
	27.07.2006. №152-ФЗ «О персональных данных» и определяет порядок обработки персональных данных и меры по обеспечению
		безопасности персональных данных&nbsp;ООО «СтройСнаб»&nbsp;(далее – Оператор).
	</p>
	...
	<ol class="policy__list">
		...
		<li class="policy__list-item">
			Пользователь – любой посетитель веб-сайта&nbsp;http://spb178.com;
		</li>
		<li class="policy__list-item">
	...
	<ol class="policy__list">
		...
		<li class="policy__list-item">
			Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу&nbsp;http://spb178.com/policy.
		</li>
	</ol>
</section>
